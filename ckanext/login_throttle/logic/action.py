from ckan.plugins.toolkit import get_action, chained_action, check_access, get_or_bust
...
def login_throttle_user_reset(context, data_dict):
    ...
    address: user name
    """
    check_access("login_throttle_user_reset", context, data_dict)
...
def login_throttle_address_reset(context, data_dict):
    ...
    address: IP address
    """
    check_access("login_throttle_address_reset", context, data_dict)
...
def login_throttle_user_show(context, data_dict):
    ...
    user: user name
    """
    check_access("login_throttle_user_show", context, data_dict)
    user = get_or_bust(data_dict, "user")
...
def login_throttle_address_show(context, data_dict):
    ...
    check_access("login_throttle_address_show", context, data_dict)
    address = get_or_bust(data_dict, "address")
...
def user_update(up_func, context, data_dict):
    ...
    get_action("login_throttle_user_reset")(
